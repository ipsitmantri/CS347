...
// Returns the number of virtual pages in the user part of the address space
// of the process
int
numvp(struct proc* currproc)
{
  uint sz = currproc->sz;
  int counts = sz / PGSIZE;
  return counts;
}

// Returns the number of physical pages in the user part of the address space
// of the process
int
numpp(struct proc* currproc)
{
  uint sz = currproc->sz;
  char *a;
  char *last;
